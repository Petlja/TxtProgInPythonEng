...
prozor = petljapg.open_window(300, 300, "Кућа")
...
platno.fill(pg.Color("lightblue")) # bojimo pozadinu ekrana u svetlo plavo

pg.draw.circle(platno, pg.Color("orange"), (250, 180), 30)   # sunce
pg.draw.rect(platno, pg.Color("green"), (0, 200, 300, 100))  # trava
pg.draw.rect(platno, pg.Color("brown"), (50, 150, 150, 100)) # kuca
pg.draw.polygon(platno, pg.Color("red"), [(50, 150), (125, 100), (200, 150)]) # krov
#################
