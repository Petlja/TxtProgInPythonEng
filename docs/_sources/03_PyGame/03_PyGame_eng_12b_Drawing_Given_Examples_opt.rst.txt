...
.. activecode:: PyGame_practice1a_fence_eng
   :nocodelens:
   :enablecopy:
   :modaloutput:
   :playtask:
   :includexsrc: src\PyGame\1_Drawing\4_ByGrid_Additional\fence_assist_eng.py
   
.. reveal:: PyGame_practice1a_fence_reveal_eng
   :showtitle: Show solution
   :hidetitle: Hide solution

   The complete program is provided, you can try it here as well.
	       
   .. activecode:: PyGame_practice1a_fence_solution_eng
      :nocodelens:
      :enablecopy:
      :modaloutput:
      :includesrc: src\PyGame\1_Drawing\4_ByGrid_Additional\fence_eng.py
...
.. activecode:: PyGame_practice1a_building_eng
   :nocodelens:
   :enablecopy:
   :modaloutput:
   :playtask:
   :includexsrc: src\PyGame\1_Drawing\4_ByGrid_Additional\building_assist_eng.py
   
.. commented out 

    .. reveal:: PyGame_practice1a_building_reveal_eng
       :showtitle: Show solution
       :hidetitle: Hide solution

       The complete program is provided, you can try it here as well.
               
       .. activecode:: PyGame_practice1a_building_solution_eng
          :nocodelens:
          :enablecopy:
          :modaloutput:
          :includesrc: src\PyGame\1_Drawing\4_ByGrid_Additional\building_eng.py
...
.. activecode:: PyGame_stickman_eng
   :nocodelens:
   :enablecopy:
   :modaloutput:
   :playtask:
   :includexsrc: src\PyGame\1_Drawing\4_ByGrid_Additional\stickman_assist_eng.py
   
.. commented out 

    .. reveal:: PyGame_practice1a_stickman_reveal_eng
       :showtitle: Show solution
       :hidetitle: Hide solution

       The complete program is provided, you can try it here as well.
               
       .. activecode:: PyGame_practice1a_stickman_solution_eng
          :nocodelens:
          :enablecopy:
          :modaloutput:
          :includesrc: src\PyGame\1_Drawing\4_ByGrid_Additional\stickman_eng.py
...
.. activecode:: PyGame_practice1a_cat_eng
   :nocodelens:
   :enablecopy:
   :modaloutput:
   :playtask:
   :includexsrc: src\PyGame\1_Drawing\4_ByGrid_Additional\cat_assist_eng.py

.. reveal:: PyGame_practice1a_cat_reveal_eng
   :showtitle: Show solution
   :hidetitle: Hide solution

   The complete program is provided, you can try it here as well.
	       
   .. activecode:: PyGame_practice1a_cat_solution_eng
      :nocodelens:
      :enablecopy:
      :modaloutput:
      :includesrc: src\PyGame\1_Drawing\4_ByGrid_Additional\cat_eng.py
