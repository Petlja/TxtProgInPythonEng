...
.. activecode:: PyGame__interact_crossword_eng
    :nocodelens:
    :enablecopy:
    :modaloutput:
    :includesrc: src/PyGame/3_Interaction/3e_Keyboard_events/crossword_eng.py
...
.. activecode:: PyGame__interact_pacman1_eng
    :nocodelens:
    :enablecopy:
    :modaloutput:
    :playtask:
    :includehsrc: src/PyGame/3_Interaction/3e_Keyboard_events/pacman1_eng.py
...
.. activecode:: PyGame__interact_labyrinth_eng
    :nocodelens:
    :enablecopy:
    :modaloutput:
    :includehsrc: src/PyGame/3_Interaction/3e_Keyboard_events/labyrinth_edit_and_search_eng.py
...
.. activecode:: PyGame__interact_typing_tutor_eng
    :nocodelens:
    :enablecopy:
    :modaloutput:
    :includesrc: src/PyGame/3_Interaction/3e_Keyboard_events/typing_tutor_eng.py
