...
.. activecode:: PyGame_loop__target_fixed_eng
   :nocodelens:
   :enablecopy:
   :modaloutput:
   :includesrc: src\PyGame\1_Drawing\7a_UsingLoops\Examples\circles_target_fixed_eng.py
...
.. activecode:: PyGame_loop__target_flexible_eng
   :nocodelens:
   :enablecopy:
   :modaloutput:
   :includesrc: src\PyGame\1_Drawing\7a_UsingLoops\Examples\circles_target_flexible_eng.py
...
.. activecode:: PyGame_loop__antenna_eng
   :nocodelens:
   :enablecopy:
   :modaloutput:
   :includesrc: src\PyGame\1_Drawing\7a_UsingLoops\Examples\antenna1_eng.py
...
.. dragndrop:: pygame__loop_quiz_match_series_eng
    :feedback: try again!
...
.. dragndrop:: pygame__loop_quiz_match_series2_eng
    :feedback: try again!
...
.. mchoice:: pygame__loop_quiz_range01_eng
    :answer_a: x = 25 * i + 50
    :answer_b: x = (25 + i) * 50
    :answer_c: x = 25 * 2*i+1
    :answer_d: x = 25 + 50 * i
...
.. activecode:: PyGame_loop__ladder_eng
    :nocodelens:
    :enablecopy:
    :modaloutput:
    :playtask:
    :includexsrc: src\PyGame\1_Drawing\7a_UsingLoops\Tasks\ladder_eng.py
...
.. reveal:: PyGame_loop__ladder_reveal_eng
    :showtitle: Hint
    :hidetitle: Hide hint
    ...
    .. mchoice:: pygame__loop_quiz_range1_eng
...
.. activecode:: PyGame_loop__trees_eng
    :nocodelens:
    :enablecopy:
    :modaloutput:
    :playtask:
    :includexsrc: src\PyGame\1_Drawing\7a_UsingLoops\Tasks\trees_eng.py
...
.. reveal:: PyGame_loop__trees_reveal_eng
    :showtitle: Hint
    :hidetitle: Hide hint

    The program can look like this:
    
    .. activecode:: PyGame_loop__trees_solution_eng
        :nocodelens:
        :enablecopy:
        :modaloutput:
        :includexsrc: src\PyGame\1_Drawing\7a_UsingLoops\Tasks\trees_eng.py
...
.. activecode:: PyGame_loop__grid_eng
    :nocodelens:
    :enablecopy:
    :modaloutput:
    :playtask:
    :includexsrc: src\PyGame\1_Drawing\7a_UsingLoops\Tasks\grid_eng.py
