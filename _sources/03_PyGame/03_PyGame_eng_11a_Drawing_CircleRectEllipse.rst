...
- The *canvas* parameter is the area in which we draw. In this guide, programs will already have a formed variable (more specifically object) *canvas*, obtained as the result from a call of the ``petljapg.open_window`` function.
...
.. activecode:: pygame__drawing_primirives_def_eng
    :nocodelens:
    :modaloutput: 

    import pygame as pg, petljapg
    canvas = petljapg.open_window(200, 200, "Pygame")
...
.. activecode:: pygame__drawing_rectangles_def_eng
    :passivecode: true
...
.. activecode:: pygame__drawing_ellipse_def_eng
    :passivecode: true
...
.. activecode:: pygame__drawing_circle_def_eng
    :passivecode: true
...
.. mchoice:: pygame__drawing_quiz_circle_arglist_eng
   :multiple_answers:
...
.. mchoice:: pygame__drawing_quiz_circle_right_args_eng
...
.. mchoice:: pygame__drawing_quiz_circle_opt_arg_eng
...
.. mchoice:: pygame__drawing_quiz_rect_args_1_eng
   :answer_a: Top-left vertex coordinates
...
.. mchoice:: pygame_quiz_argumenti_crtanja_pravougaonika_2_eng
...
.. mchoice:: pygame_quiz_argumenti_crtanja_pravougaonika_3_eng
...
.. activecode:: PyGame_target_eng
   :nocodelens:
   :enablecopy:
   :modaloutput:
   :playtask:
   :includexsrc: src/PyGame/1_Drawing/1_BasicExamples/target_eng.py
...
.. activecode:: PyGame_duckling_eng
   :nocodelens:
   :enablecopy:
   :modaloutput:
   :playtask:
   :includexsrc: src/PyGame/1_Drawing/1_BasicExamples/duckling_eng.py
