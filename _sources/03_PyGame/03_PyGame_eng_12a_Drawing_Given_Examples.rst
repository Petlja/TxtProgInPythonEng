...
.. activecode:: PyGame_ladder_assist_eng
   :nocodelens:
   :enablecopy:
   :modaloutput:
   :includexsrc: src\PyGame\1_Drawing\3_ByGrid\ladder_small_eng.py
...
.. activecode:: PyGame_antenna_simple_assist_eng
    :nocodelens:
    :enablecopy:
    :modaloutput:
    :playtask:
    :includexsrc: src\PyGame\1_Drawing\3_ByGrid\antenna_assist_eng.py
...
.. reveal:: PyGame_antenna_simple_reveal_eng
   :showtitle: Show solution
   :hidetitle: Hide solution

   The complete program is provided, you can try it here as well.
	       
   .. activecode:: PyGame_antenna_simple_solution_eng
      :nocodelens:
      :enablecopy:
      :modaloutput:
      :includesrc: src\PyGame\1_Drawing\3_ByGrid\antenna_eng.py
...
.. activecode:: PyGame_practice1a_balance_eng
   :nocodelens:
   :enablecopy:
   :modaloutput:
   :playtask:
   :includexsrc: src\PyGame\1_Drawing\3_ByGrid\balance_assist_eng.py
...
.. commented out 
    ...
    .. reveal:: PyGame_practice1a_balance_reveal_eng
       :showtitle: Show solution
       :hidetitle: Hide solution

       The complete program is provided, you can try it here as well.
               
       .. activecode:: PyGame_practice1a_balance_solution_eng
          :nocodelens:
          :enablecopy:
          :modaloutput:
          :includesrc: src\PyGame\1_Drawing\3_ByGrid\balance_eng.py
...
.. activecode:: PyGame_practice1a_smiley_eng
   :nocodelens:
   :enablecopy:
   :modaloutput:
   :playtask:
   :includexsrc: src\PyGame\1_Drawing\3_ByGrid\smiley_assist_eng.py
...
.. commented out
    ...
    .. reveal:: PyGame_practice1a_smiley_reveal_eng
       :showtitle: Show solution
       :hidetitle: Hide solution

       The complete program is provided, you can try it here as well.
               
       .. activecode:: PyGame_practice1a_smiley_solution_eng
          :nocodelens:
          :enablecopy:
          :modaloutput:
          :includesrc: src\PyGame\1_Drawing\3_ByGrid\smiley_eng.py
...
.. reveal:: PyGame_practice1a_house_circle_center_reveal_eng
...
.. activecode:: PyGame_practice1a_house_eng
   :nocodelens:
   :enablecopy:
   :modaloutput:
   :playtask:
   :includexsrc: src\PyGame\1_Drawing\3_ByGrid\house2D_assist_eng.py
...
.. commented out
    ...
    .. reveal:: PyGame_practice1a_house_reveal_eng
       :showtitle: Show solution
       :hidetitle: Hide solution

       The complete program is provided, you can try it here as well.
               
       .. activecode:: PyGame_practice1a_house_solution_eng
          :nocodelens:
          :enablecopy:
          :modaloutput:
          :includesrc: src\PyGame\1_Drawing\3_ByGrid\house2D_eng.py
...
.. activecode:: PyGame_practice1a_trees_eng
   :nocodelens:
   :enablecopy:
   :modaloutput:
   :playtask:
   :includexsrc: src\PyGame\1_Drawing\3_ByGrid\trees_assist_eng.py
   
.. commented out

    .. reveal:: PyGame_practice1a_trees_reveal_eng
       :showtitle: Прикажи решење
       :hidetitle: Сакриј решење

       The complete program is provided, you can try it here as well.
               
       .. activecode:: PyGame_practice1a_trees_solution_eng
          :nocodelens:
          :enablecopy:
          :modaloutput:
          :includesrc: src\PyGame\1_Drawing\3_ByGrid\trees_eng.py
