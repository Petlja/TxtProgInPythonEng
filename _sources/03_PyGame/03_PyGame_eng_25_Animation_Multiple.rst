...
.. activecode:: PyGame__anim_balls_bouncing_eng
    :nocodelens:
    :modaloutput:
    :includesrc: src/PyGame/2_Animation/2e_Anim_Multiple/balls_bouncing_eng.py
...
.. activecode:: PyGame__anim_trough_stars_eng
    :nocodelens:
    :modaloutput:
    :includesrc: src/PyGame/2_Animation/2e_Anim_Multiple/trough_stars_eng.py
...
.. activecode:: PyGame__anim_snowflakes_eng
    :nocodelens:
    :modaloutput:
    :playtask:
    :includehsrc: src/PyGame/2_Animation/2e_Anim_Multiple/snowflakes_eng.py

    import random, pygame as pg, petljapg
    (width, height) = (800, 400)
    canvas = petljapg.open_window(width, height, "Snowflakes")
...
.. activecode:: PyGame__anim_balls_passing_eng
    :nocodelens:
    :modaloutput:
    :playtask:
    :includehsrc: src/PyGame/2_Animation/2e_Anim_Multiple/balls_passing_eng.py
...
.. activecode:: PyGame__anim_gliding_text_eng
    :nocodelens:
    :modaloutput:
    :includesrc: src/PyGame/2_Animation/2e_Anim_Multiple/gliding_text_eng.py
