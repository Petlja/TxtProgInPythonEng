...
.. activecode:: PyGame__interact_switch_read_state_bad_eng
    :nocodelens:
    :enablecopy:
    :modaloutput:
    :includesrc: src/PyGame/3_Interaction/3d_Mouse_events/Switch_read_state_eng.py
...
.. activecode:: PyGame__interact_Switch_eng
    :nocodelens:
    :enablecopy:
    :modaloutput:
    :includesrc: src/PyGame/3_Interaction/3d_Mouse_events/Switch_eng.py
