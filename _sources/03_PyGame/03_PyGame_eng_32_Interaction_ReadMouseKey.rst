...
.. activecode:: PyGame__interact_put_ball_into_box_part_eng
    :passivecode: true
...
.. activecode:: PyGame__interact_put_ball_into_box_eng
    :nocodelens:
    :enablecopy:
    :modaloutput:
    :includesrc: src/PyGame/3_Interaction/3b_Mouse_readkey/put_ball_into_box_eng.py    
...
.. activecode:: PyGame__interact_to_and_from_mouse_eng
    :nocodelens:
    :modaloutput:
    :playtask:
    :includehsrc: src/PyGame/3_Interaction/3b_Mouse_readkey/to_and_from_mouse_eng.py
    
    import pygame as pg, petljapg
    (width, height) = (400, 400)
    canvas = petljapg.open_window(width, height, "Ball following the mouse")
...
.. activecode:: PyGame__interact_laser_eng
    :nocodelens:
    :modaloutput:
    :playtask:
    :includehsrc: src/PyGame/3_Interaction/3b_Mouse_readkey/laser_eng.py

    import pygame as pg, petljapg
    width, height = 400, 400
    canvas = petljapg.open_window(width, height, "Laser")
    ...
    petljapg.frame_loop(15, new_frame)
...
.. commented out
    ...
    .. activecode:: PyGame__interact_bg_color_eng
        :nocodelens:
        :modaloutput:
        :includesrc: src/PyGame/3_Interaction/3b_Mouse_readkey/bg_color_eng.py
