...
.. activecode:: console__mathfunc_promo_material_eng
...
.. activecode:: console__mathfunc_lemonade_eng

.. reveal:: console__mathfunc_lemonade_reveal_eng
   :showtitle: Help
   :hidetitle: Hide help
   
   To complete the following program, use some of the rounding functions.
   
   .. activecode:: console__mathfunc_lemonade_solution_eng
...
.. activecode:: console__mathfunc_late_game_eng

.. reveal:: console__mathfunc_late_game_reveal_eng
   :showtitle: Help
   :hidetitle: Hide help
   
   One possible solution is partially written below. Try to complete it.
   
   .. activecode:: console__mathfunc_late_game_help_eng
...
.. commented out
   ...
   .. activecode:: console__mathfunc_late_game_solution_eng
...
.. activecode:: console__mathfunc_buses_eng

.. commented out
    
    .. reveal:: console__mathfunc_buses_reveal_eng
       :showtitle: Help
       :hidetitle: Hide help
       
       To complete the following program, use one of the math functions you have learned.
       
       .. activecode:: console__mathfunc_buses_solution_eng
...
.. activecode:: console__mathfunc_videolessons_eng
