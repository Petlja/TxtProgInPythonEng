...
- If you have problems in solving some of the tasks, do not worry - it's completely normal. Have patience and be careful. Try to understand the message about the problem. If necessary, reanalyze the examples and explanations that you have been reading up to then. In case you do peek into a solution, you can copy it or type it with or without understanding, but, to achieve progress in learning programming, it is important that you try to fully comprehend the solutions and ideas behind them.
...
.. toctree::
    ...
    01_Karel_eng_00_intro.rst
    02_Console/02_Console_eng_00_Intro.rst
    03_PyGame/03_PyGame_eng_Index.rst
