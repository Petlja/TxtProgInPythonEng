...
.. karel:: Karel_while__many_squares_and_ball_at_the_end_eng
   :blockly:
...
.. karel:: Karel_while__one_square_many_balls_eng
   :blockly:
...
.. commented out
   .. reveal:: Karel_while__one_square_many_balls_reveal_eng
      :showtitle: Solution
      :hidetitle: Hide solution
   
      .. activecode:: Karel_while__one_square_many_balls_solution_eng
         :passivecode: true
...
.. karel:: Karel_while__many_squares_and_ball_at_each_eng
   :blockly:
...
.. karel:: Karel_while__bring_balls_to_front_square_eng
    :blockly:
...
.. commented out
   .. reveal:: Karel_while__bring_balls_to_front_square_reveal_eng
       :showtitle: Solution
       :hidetitle: Hide solution
   
       .. activecode:: Karel_while__bring_balls_to_front_square_solution_eng
           :passivecode: true
...
.. karel:: Karel_while__put_balls_in_upper_row_eng
   :blockly:
...
.. reveal:: Karel_while__put_balls_in_upper_row_reveal_eng
    :showtitle: Hint
    :hidetitle: Hide hint
    
    We give instructions that resemble the program:

    .. activecode:: Karel_while__put_balls_in_upper_row_solution_eng
        :passivecode: true
